...
public class SzczepieniaListaAdapter extends ArrayAdapter<SzczepieniaLista> {
 ...
 * */
    ...
    private static final String LOG_TAG = SzczepieniaListaAdapter.class.getSimpleName();
     ...
     */
    public SzczepieniaListaAdapter(Activity context, ArrayList<SzczepieniaLista> androidFlavors) {
